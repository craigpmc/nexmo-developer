...
class JWTGenerator extends Component {
    ...
    renderCallout() {
        ...
        let message = `<h4>Give us your <code>private key</code> and <code>application_id</code> and we'll create a JWT for you</h4> It's all done client-side, so your private key never leaves your browser`;
        let calloutType = 'tip';
        ...
        if (!this.privateKeyInput.value) {
            return this.generateCallout('warning', 'Next, give us a Private Key');
        }

        if (!this.applicationIdInput.value) {
            return this.generateCallout('warning', 'Next, give us an Application ID');
        }
